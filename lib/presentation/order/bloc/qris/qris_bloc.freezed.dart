...
abstract class _GenerateQRCode implements QrisEvent {
  const factory _GenerateQRCode(
      ...
      required final int grossAmount}) = _$GenerateQRCodeImpl;
...
abstract class _CheckPaymentStatus implements QrisEvent {
  const factory _CheckPaymentStatus({required final String orderId}) =
...
class _$QrisResponseImpl implements _QrisResponse {
  const _$QrisResponseImpl({required this.qrisResponseModel});
...
abstract class _QrisResponse implements QrisState {
  const factory _QrisResponse(
          {required final QrisResponseModel qrisResponseModel}) =
      _$QrisResponseImpl;
...
class _$StatusCheckImpl implements _StatusCheck {
  const _$StatusCheckImpl({required this.qrisStatusResponseModel});
...
abstract class _StatusCheck implements QrisState {
  const factory _StatusCheck(
          {required final QrisStatusResponseModel qrisStatusResponseModel}) =
      _$StatusCheckImpl;

...
abstract class _Login implements LoginEvent {
  const factory _Login({required final AuthRequestModel authRequestModel}) =
      _$LoginImpl;
...
class __$$SuccessImplCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_$SuccessImpl(
      authResponseModel: null == authResponseModel
...
class _$SuccessImpl implements _Success {
  const _$SuccessImpl({required this.authResponseModel});
...
abstract class _Success implements LoginState {
  const factory _Success({required final AuthResponseModel authResponseModel}) =
      _$SuccessImpl;
